...
function Brick:init(x, y)
    ...
    -- if brick is a locked brick
    self.isLockBrick = false
...
function Brick:hit()
    ...
    -- if locked brick was hit, remove brick
    if self.isLockBrick then
        self.inPlay = false
...
function Brick:render()
    if self.inPlay then
        if self.isLockBrick then
            -- if the brick is a lock brick, render locked brick
