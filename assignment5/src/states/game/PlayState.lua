...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['idle'] = function() return PlayerIdleState(self.player, self.dungeon.currentRoom.objects) end,
        ['swing-sword'] = function() return PlayerSwingSwordState(self.player, self.dungeon) end,
        ['carry-idle'] = function() return PlayerObjectIdleState(self.player) end,
        ['carry-walk'] = function() return PlayerObjectWalkState(self.player, self.dungeon) end,
    ...
    self.player:changeState('idle', self.dungeon.objects)
end
