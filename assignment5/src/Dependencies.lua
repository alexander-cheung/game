...
require 'src/states/entity/player/PlayerObjectIdleState'
require 'src/states/entity/player/PlayerThrowState'
require 'src/states/entity/player/PlayerObjectWalkState'

require 'src/states/game/GameOverState'
require 'src/states/game/PlayState'
require 'src/states/game/StartState'

-- set filter before making images
...
gTextures = {
    ...
    ['pot-lift'] = love.graphics.newImage('graphics/character_pot_lift.png'),
...
gFrames = {
    ...
    ["pots"] = table.slice(GenerateQuads(gTextures["tiles"], 16, 16), 110, 111)
}
...
gSounds = {
    ...
    ['pot-break'] = love.audio.newSource('sounds/pot-break.wav', "static"),
