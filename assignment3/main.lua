...
function love.mousepressed(x, y, button)
    love.mouse.info["x"], love.mouse.info["y"] = push:toGame(x, y)
    love.mouse.info["leftClick"] = true
end

-- called when the mouse moves
function love.mousemoved(x, y)
    love.mouse.info["x"], love.mouse.info["y"] = push:toGame(x, y)    
    love.mouse.info["moved"] = true
end

function love.mouse.getInfo()
    return love.mouse.info
end
