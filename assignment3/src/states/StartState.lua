...
function StartState:init()
    ...
    self.colors = {
        [1] = {217 / 255, 87 / 255, 99 / 255},
        [2] = {95 / 255, 205 / 255, 228 / 255},
        [3] = {251 / 255, 242 / 255, 54 / 255},
        [4] = {118 / 255, 66 / 255, 138 / 255},
        [5] = {153 / 255, 229 / 255, 80 / 255},
        [6] = {223 / 255, 113 / 255, 38 / 255}
    }
...
function StartState:drawOptions(y)
    ...
    if self.currentMenuItem == 1 then
        ...
        love.graphics.setColor(48 / 255, 96 / 255, 130 / 255)
    end
